...
The Gestalt principle of similarity was used to how if a gene is in set or not. If a gene was in a set, they have the same black color, and if they are not in a set, then they had the same white color. Continuity was used for the vertical lines connecting filled dots, which created a flow that unified the connected dots.
