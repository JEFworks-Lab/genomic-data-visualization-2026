<img width="468" height="494" alt="image" src="https://github.com/user-attachments/assets/8ffce4cd-188b-474f-b5ff-9f8812c85feb" />---
layout: post
title:  "HW3"
author: Aarna
jhed: asangha1
...
The presence of these markers, combined with the cluster’s distinct position in PCA space and its spatial localization, supports the conclusion that Cluster 3 represents a collecting duct cell population, likely enriched for Aqp2-positive principal cells with associated intercalated cell features. Together, the clustering, spatial distribution, and marker gene expression provide consistent evidence that Cluster 3 corresponds to an Aqp2-positive renal epithelial cell type rather than merely a technical artifact.
